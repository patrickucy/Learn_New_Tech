...
//				long when = e.getWhen(); // in this project, we don't need when, here is just a demo of how powerful KeyEvent is
    ...
    private void removeLine(int row) {
        ...
        for (int i = row; i >= 1; i--) {
            ...
            // arraycoy -> copy from original copy and delete the original one
    ...
    /**
     * we use main function to initializa our UI
     */
...
//		frame.setUndecorated(true); // get rid of window frame
        ...
        // when close your window, it terminates the java programe at the same time
